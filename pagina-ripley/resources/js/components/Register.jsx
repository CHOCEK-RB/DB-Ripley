    ...
    <div className="container">
      ...
      <div className="form-container">
        ...
        <div className="description">
          <p className="description-title">¿Eres nuevo en Ripley?</p>
          <p className="content">Regístrate y disfruta de nuestros beneficios y una experiencia de compra más rápida y sencilla.</p>
        </div>
